...
export const createCustomerParameters = (_context: Context) =>
  z.object({
...
export const listPricesParameters = (_context: Context) =>
  z.object({
    product: z
      .string()
      .optional()
...
export const finalizeInvoiceParameters = (_context: Context) =>
  z.object({
    invoice: z.string().describe('The ID of the invoice to finalize.'),
  });

export const retrieveBalanceParameters = (_context: Context) => z.object({});

export const createRefundParameters = (_context: Context) =>
  z.object({
    payment_intent: z
      .string()
...
export const searchDocumentationParameters = (_context: Context) =>
  z.object({
    question: z
      .string()
      .describe(
